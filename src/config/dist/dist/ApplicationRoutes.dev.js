...
var ApplicationRoutes = function ApplicationRoutes() {
  ...
  return react_1["default"].createElement(react_router_dom_1.BrowserRouter, null, react_1["default"].createElement(antd_1.Layout, null, react_1["default"].createElement(Sider, {
    trigger: null,
    collapsible: true,
    collapsed: collapse
  }, react_1["default"].createElement(Sidebar_1["default"], null)), react_1["default"].createElement(antd_1.Layout, null, react_1["default"].createElement(Header, {
    className: "siteLayoutBackground",
    style: {
      padding: 0,
      background: "#001529"
    }
  }, react_1["default"].createElement(collapse ? icons_1.MenuUnfoldOutlined : icons_1.MenuFoldOutlined, {
    className: "trigger",
    ...
    path: "/",
    component: ProgramList_1["default"]
    ...
    path: "/programResult",
    component: ProgramResult_1["default"]
  }), react_1["default"].createElement(react_router_dom_1.Route, {
    path: "/videos",
